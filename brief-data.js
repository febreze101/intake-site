  ...
  sections: [
    ...
    },
    {
      ...
      questions: [
        ...
        { id: "s2_sell", name: "What you sell", type: "textarea", label: "What do you actually sell?", help: "Products, services, packages, price points. If there are tiers, list them.", required: true },
        { id: "s2_revenue_now", name: "Current revenue driver", type: "textarea", label: "Where does most of your revenue come from today?", help: "Which product or service, and roughly what share. Pre-launch? What do you expect it to be?", required: true },
        { id: "s2_revenue_future", name: "Future direction", type: "textarea", label: "What do you want that to be in two years?", help: "The thing you're trying to grow into.", required: true },
        {
          id: "s2_findings", name: "How people find you", type: "checkbox", label: "How do people find you right now?",
          options: ["Word of mouth", "Instagram", "TikTok", "Google", "Foot traffic", "Press", "Email list", "Paid ads", "Wholesale", "Events", "We're not really being found"],
        },
        ...
        { id: "s2_blocker", name: "Biggest blocker", type: "textarea", label: "What's the single biggest thing holding the business back right now?", required: true },
      ],
    },
    {
      heading: "Audience",
      questions: [
        { id: "s2_customer", name: "Ideal customer", type: "textarea", label: "Describe your ideal customer as a specific person, not a demographic.", help: "Not “women 25–40.” What's their life like, what do they care about, where do they already hang out? Give me someone I could picture.", required: true },
        {
          id: "s2_customer_match", name: "Matches reality", type: "radio", label: "Is that who's actually buying from you today?",
        ...
        {
          id: "s2_groups", name: "Distinct audiences", type: "radio", label: "Are there distinct groups you serve?",
        ...
        { id: "s2_job", name: "Job to be done", type: "textarea", label: "What is your customer actually trying to accomplish when they come to you?", help: "The job they're hiring you for.", required: true },
        { id: "s2_hesitate", name: "What makes them hesitate", type: "textarea", label: "What makes them hesitate?", help: "Price, trust, not understanding the process, a bad past experience.", required: true },
        { id: "s2_happy", name: "What happy customers say", type: "textarea", label: "What do customers say when they're happy?", help: "Actual quotes if you have them — reviews, DMs, emails.", required: true },
      ],
    },
    {
      heading: "Positioning & competition",
      questions: [
        { id: "s2_competitors", name: "Competitors", type: "textarea", label: "Name three to five businesses you consider competition.", help: "Links please.", required: true },
        { id: "s2_comp_good", name: "What competitors do well", type: "textarea", label: "What do they do well?", required: true },
        ...
        { id: "s2_lose_reason", name: "Why they'd pick someone else", type: "textarea", label: "If a customer chose a competitor over you, what would the reason most likely be?", help: "The honest answer is more useful than the flattering one.", required: true },
        { id: "s2_aspirational", name: "Aspirational brands", type: "textarea", label: "Are there brands outside your industry you want to be mentioned alongside?", help: "Optional." },
        { id: "s2_onlyx", name: "\"We're the only ___ that ___\"", type: "text", label: "Complete this: “We're the only ____ that ____.”", help: "Hard on purpose. A rough attempt is fine.", required: true },
      ],
    },
    {
      ...
      questions: [
        ...
        { id: "s2_voice_right", name: "Writing that sounds right", type: "textarea", label: "Paste something you've written that sounds right.", help: "A caption, email, menu description, about paragraph.", required: true },
        { id: "s2_voice_wrong", name: "Writing that sounds wrong", type: "textarea", label: "Anything you've written that sounds wrong?", help: "Optional." },
        {
    ...
    },
    {
      ...
      questions: [
        { id: "s2_sixmonth", name: "Six-month success", type: "textarea", label: "What has to be true six months after launch for this to have been worth it?", help: "Be specific — “more bookings” is a wish, “our Tuesday nights are full” is a goal.", required: true },
        {
          ...
          options: ["More inbound leads", "More online sales", "More bookings", "Charge more / attract better-fit clients", "Be taken seriously by a new audience", "Reduce admin and repeated explaining", "Support a launch or raise", "Other"],
        },
        {
          id: "s2_goal_secondary", name: "Secondary goals", type: "checkbox", label: "Secondary goals",
          help: "Same list, pick up to two.",
          options: ["More inbound leads", "More online sales", "More bookings", "Charge more / attract better-fit clients", "Be taken seriously by a new audience", "Reduce admin and repeated explaining", "Support a launch or raise"],
        },
        {
        ...
        },
        {
          ...
          options: ["Inquiry volume", "Conversion rate", "Revenue or average order value", "Bookings", "Newsletter signups", "Time spent answering the same questions", "Gut feel", "We don't track much right now"],
        },
